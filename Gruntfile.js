        ...
        concat: {
            ...
            js: {
                ...
                src: [
                    ...
                    'public/assets/js/vendors/magnific-popup.js',
                    'public/assets/js/vendors/select-fx.js',
                    'public/assets/js/vendors/owl.carousel.js',
                    'public/assets/js/vendors/velocity.js',
                    'public/assets/js/vendors/syntaxhighlighter/shCore.js',
                    'public/assets/js/vendors/syntaxhighlighter/shBrushPhp.js',
                    'public/assets/js/vendors/syntaxhighlighter/shBrushXml.js',
                    'public/assets/js/vendors/syntaxhighlighter/shBrushJScript.js',
                    'public/assets/js/vendors/syntaxhighlighter/shBrushSql.js',
                    'public/assets/js/vendors/syntaxhighlighter/shBrushBash.js',
                    'public/assets/js/vendors/syntaxhighlighter/shBrushPlain.js',
